...
%h.xt= patch(0,0,'g','erasemode','xor'); 
%h.xm= patch(0,0,'r','erasemode','xor'); 
%h.obs= plot(0,0,'y','erasemode','xor'); 
%h.xfp= plot(0,0,'r.','erasemode','background');
%h.xvp= plot(0,0,'r.','erasemode','xor'); 
%h.cov= plot(0,0,'erasemode','xor'); 
